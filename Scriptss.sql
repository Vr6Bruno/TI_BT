...
/*Exclui o banco de dados e usuário*/

DROP DATABASE atividadescomplementares;
DROP USER IF EXISTS uvv;

/*Cria o banco de dados e o usuário*/

CREATE USER uvv WITH PASSWORD 'computacao@raiz';
CREATE DATABASE atividadescomplementares
owner uvv
template template0
encoding 'UTF8'
...
\c 'dbname=atividadescomplementares user=uvv password=computacao@raiz';

/*Cria o esquema certificados, onde será inserido o banco de dados atividadescomplementares*/

CREATE SCHEMA certificados AUTHORIZATION uvv;

ALTER USER uvv
SET SEARCH_PATH TO certificados, "$user", public;
SET SEARCH_PATH TO certificados, "$user", public;
